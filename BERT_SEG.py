...
def main(_):
    ...
    if FLAGS.do_train:
        train_examples = FLAGS.training_examples
        num_train_steps = int(
    ...
    if FLAGS.do_train:
        train_file = ["./tfdata/sample.tf_record"]
       #["./tfdata/train1.tf_record", "./tfdata/train2.tf_record", "./tfdata/train3.tf_record",
       #               "./tfdata/train4.tf_record", "./tfdata/train5.tf_record", "./tfdata/train6.tf_record",
       #               "./tfdata/train7.tf_record", "./tfdata/train8.tf_record", "./tfdata/train9.tf_record",
       #               "./tfdata/train10.tf_record", "./tfdata/train11.tf_record", "./tfdata/train12.tf_record",
       #               "./tfdata/train13.tf_record", "./tfdata/train14.tf_record", "./tfdata/train15.tf_record" ]
        tf.logging.info("***** Running training *****")
        tf.logging.info("  Num examples = %d", FLAGS.training_examples)
    ...
    if FLAGS.do_eval:
        ...
        tf.logging.info("  Num examples = %d", FLAGS.eval_examples)
    ...
    if FLAGS.do_predict:
        ...
        #predict_file = "./data/predict.tf_record"
        predict_file = "./tfdata/sample.tf_record"
        tf.logging.info("***** Running prediction*****")
        tf.logging.info("  Num examples = %d", FLAGS.pred_examples)
